      ...
      {claimedStages.length > 0 && (
        <div style={{ marginBottom: isMe ? 10 : 0 }}>
          ...
          {claimedStages.map(s => {
            ...
            return (
              <div key={s} style={{ display: "flex", alignItems: "center", gap: 4, fontSize: 11, color: t.textSec, marginBottom: 2 }}>
      ...
      {isMe && onChangeAvatar && (
        <>
          <button
            ...
            style={{ width: "100%", background: u.color + "18", border: `1px solid ${u.color}44`, borderRadius: 12, padding: "8px", cursor: "pointer", fontSize: 12, color: u.color, fontWeight: 700, fontFamily: "var(--font-dm-mono), monospace", textAlign: "center" }}
          >
            change avatar →
          </button>
        </>
