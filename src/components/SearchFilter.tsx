  ...
  return (
    <div style={{ display: "flex", gap: 6, marginBottom: 8, alignItems: "center", flexWrap: "wrap" }}>
      <div style={{ flex: "1 1 200px", position: "relative" }}>
        <input value={searchQ} onChange={e => setSearchQ(e.target.value)} placeholder="Search stages..." style={{ width: "100%", background: t.bgCard, border: `1px solid ${t.border}`, borderRadius: 10, padding: "7px 60px 7px 28px", fontSize: 10, color: t.text, fontFamily: "var(--font-dm-sans), sans-serif", outline: "none" }} />
        ...
        <span style={{ position: "absolute", right: 8, top: "50%", transform: "translateY(-50%)", fontSize: 8, color: t.textDim, fontFamily: "var(--font-dm-mono), monospace", background: t.surface, border: `1px solid ${t.border}`, borderRadius: 5, padding: "1px 5px", pointerEvents: "none", whiteSpace: "nowrap" }}>⌘K</span>
      </div>
