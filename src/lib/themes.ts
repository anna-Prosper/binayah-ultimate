...
export const mkTheme = (id: string, isDark: boolean) => {
  ...
  const bases: Record<string, ThemeBase> = {
    warroom: {
      ...
      border: d?"#1a1530":"#ccc4b8", text: d?"#f0ecff":"#1a1510", textSec: d?"#a89ec8":"#4a4238", textMuted: d?"#5c5280":"#8a8070", textDim: d?"#3a3258":"#9a9088", surface: d?"#0f0c1a":"#edeae4",
    ...
    lab: {
      ...
      border: d?"#122828":"#b0ccc0", text: d?"#e8fff4":"#0c1a14", textSec: d?"#8ab8a4":"#3a5a48", textMuted: d?"#4a7a6a":"#6a9a82", textDim: d?"#2a5040":"#7a9888", surface: d?"#081010":"#e4ede8",
    ...
    engine: {
      ...
      border: d?"#2a1e1e":"#c4b0a0", text: d?"#fff0e8":"#1a1008", textSec: d?"#c8a898":"#5a4030", textMuted: d?"#7a5a4a":"#9a7a68", textDim: d?"#4a3028":"#9a8070", surface: d?"#100c0c":"#e8e0d8",
    ...
    nerve: {
      ...
      border: d?"#18182e":"#b8c0d8", text: d?"#e8ecff":"#0c1020", textSec: d?"#9aa8cc":"#3a4868", textMuted: d?"#506080":"#7080a0", textDim: d?"#303858":"#8090b0", surface: d?"#0a0a14":"#e6e8f0",
